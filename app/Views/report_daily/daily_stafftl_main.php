...
$currentMonth = date('m', $yesterday);
$currentYear = date('Y', $yesterday);
$currentDay = date('d', $yesterday);
?>
...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-auto">
        <div class="card p-1">
          <form id="filterForm" action="<?= $this->BASE_URL; ?>Report_Daily/staff_tl/1" method="POST">
...
<script>
  ...
  function showOM() {
    ...
    $.ajax({
      url: "<?= $this->BASE_URL ?>Report_Daily/staff_tl/1/date/0",
  ...
  function showTL(om_id) {
    $('span#spinner').addClass('spinner-border spinner-border-sm');
    $.ajax({
      url: "<?= $this->BASE_URL ?>Report_Daily/staff_tl/2/date/0",
      data: $("form#filterForm").serialize(),
      type: $("form#filterForm").attr("method"),
      success: function(response) {
  ...
  function showStaff(id, base) {
    $('span#spinner').addClass('spinner-border spinner-border-sm');
    $.ajax({
      url: "<?= $this->BASE_URL ?>Report_Daily/staff_tl/3/" + base + "/" + id,
      data: $("form#filterForm").serialize(),
      type: $("form#filterForm").attr("method"),
      success: function(response) {
